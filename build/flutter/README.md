...
* `pgc_3` - project identifier (lowercase, no spaces, i.e. "snake_case") used for bundle IDs and package names.
* `` - project description.
* `PGC 3` - executable or bundle name on disk.
* `PGC 3` - display name shown in window titles and about app dialogs.
